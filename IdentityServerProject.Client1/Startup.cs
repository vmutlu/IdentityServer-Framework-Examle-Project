...
namespace IdentityServerProject.Client1
{
    public class Startup
    {
        ...
        {
            services.AddHttpContextAccessor(); //ben IHttpContextAccessor her hangi bir classýn constructurunda kullanmak istersem DI containere bu servisi eklemem gerek
            ...
            //artýk gerek yok manuel olarak login olabiliyorum
                ...
                .AddOpenIdConnect("oidc", options =>
                 {
                     ...
                     {
                         RoleClaimType = "role",
                         NameClaimType = "name" // controllerda istediðim zaman ýdentity üzerinden name bilgisini almak için eklendi. Bir nevi mapleme yaptým 
                     };
                 });
